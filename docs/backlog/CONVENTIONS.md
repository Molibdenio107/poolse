...
| The season summary (`GET /facilities/:id/occupancy`) | One season, one site — POOLSE-52, criterion 11. Seven weekdays and three time bands; neither list grows as the club takes on more people, and the season is the window the figures are *about*. |
