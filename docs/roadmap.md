...
| 5.4 | Period comparison, correlation with temperature | The insight the module exists for. **Part of it arrived early** (20 September 2026): POOLSE-28 gives cost per lesson hour, per bather and per m³ on a pool's page, and a turma's own share on its page — comparable across periods because the denominators are defined once. What 5.4 still owes is month-on-month and year-on-year *comparison* on screen, and water temperature beside consumption as context |
